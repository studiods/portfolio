...
const bridge=elFromHTML(`<div class="narrative-block hm-reveal hm-data-bridge-023"><span class="narrative-subno">02.3</span><p class="hm-data-bridge-023__copy"><span class="hm-data-bridge-quote">온라인몰이 떠오르지 않는다</span>는 인식과 <span class="hm-data-bridge-quote">들어와도 다음 단계로 이어지지 않는다</span>는 행동이 겹쳤습니다.<br>그래서 목표를 화면 개편이 아니라, <span class="hm-data-bridge-quote">구매 여정 안에 하이마트의 명확한 포지션을 만드는 것</span>으로 다시 정의했습니다.</p></div>`);
