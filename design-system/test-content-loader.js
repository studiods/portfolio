...
const signal=elFromHTML(`<div class="narrative-block hm-reveal narrative-signals hm-data-metrics-021"><span class="narrative-subno">02.1</span><h3 class="narrative-title hm-data-021-title"><span>숫자는 더 단순하게 말했습니다.</span><span>유입보다 다음 행동으로 이어지는 힘이 약했습니다.</span></h3><div class="himart-brand-metric-grid himart-data-metric-grid hm-ds-subtitle-to-content" aria-label="하이마트 실제 이용 행동 주요 수치">
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">01</span><h4>유입의 상당수가 외부 맥락을<br>가진 상태에서 시작됐습니다.</h4><div class="himart-brand-metric-card__value"><p>AD · CPS · CRM 유입 비중</p><strong>68%</strong></div></article>
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">02</span><h4>기획전 유입의 절반 이상이<br>다음 탐색 없이 끝났습니다.</h4><div class="himart-brand-metric-card__value"><p>기획전 시작 후 바로 종료</p><strong>52.2%</strong></div></article>
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">03</span><h4>장바구니보다 결제 진입이<br>3배 이상 많이 발생했습니다.</h4><div class="himart-brand-metric-card__value"><p>2026.01 모바일 · 결제/장바구니</p><strong>3.1×</strong></div></article>
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">04</span><h4>검색은 보조 기능보다<br>적극적인 후보 탐색에 가까웠습니다.</h4><div class="himart-brand-metric-card__value"><p>세션 대비 검색 비중</p><strong>9.34%</strong></div></article>
...
const pattern=elFromHTML(`<div class="narrative-block hm-reveal behavior-pattern hm-data-pattern-022"><span class="narrative-subno">02.2</span><h3 class="narrative-title">데이터와 이탈 요인을 다 같이 놓고 보니<br>문제는 유입이 아니라 ‘다음 행동으로의 연결’에 있었습니다.</h3><div class="behavior-pattern-grid hm-ds-subtitle-to-content"><article class="behavior-pattern-card"><span>01</span><h4>시작점은 하나가<br>아니였습니다.</h4><p>광고·직접 유입·가격비교·CRM처럼 서로 다른 목적과 맥락을 가진 상태로 쇼핑을 시작했습니다.</p></article><article class="behavior-pattern-card"><span>02</span><h4>고객은 적극적으로 후보를<br>찾고 있었습니다.</h4><p>검색과 목적지형 기능을 활용해 필요한 상품과 조건을 스스로 좁히며 구매 후보를 만들고 있었습니다.</p></article><article class="behavior-pattern-card"><span>03</span><h4>하지만 다음 화면에서 앞선<br>맥락이 약해졌습니다.</h4><p>기획전 이후 이탈과 PDP 이후 행동 약화처럼, 관심과 판단 기준이 다음 행동까지 이어지지 않는 구간이 반복됐습니다.</p></article></div></div>`);
signal.insertAdjacentElement('afterend',pattern);

const bridge=elFromHTML(`<div class="narrative-block hm-reveal hm-data-bridge-023"><span class="narrative-subno">02.3</span><p class="hm-data-bridge-023__copy">‘온라인몰이 잘 떠오르지 않는다’는 인식과 ‘들어와도 다음 단계로 이어지지 않는다’는 행동이 겹쳤습니다. 그래서 목표를 ‘화면을 새로 만든다’가 아니라 ‘고객의 구매 여정 안에 명확한 포지션을 만든다’로 다시 정의했습니다.</p></div>`);
