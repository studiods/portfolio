...
const signal=elFromHTML(`<div class="narrative-block hm-reveal narrative-signals hm-data-metrics-021"><span class="narrative-subno">02.1</span><h3 class="narrative-title hm-data-021-title"><span>숫자는 더 단순하게 말했습니다.</span><span>유입보다 다음 행동으로 이어지는 힘이 약했습니다.</span></h3><div class="himart-brand-metric-grid himart-data-metric-grid hm-ds-subtitle-to-content" aria-label="하이마트 실제 이용 행동 주요 수치">
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">01</span><h4>유입의 상당수가 홈이 아닌,<br>외부 맥락을 가진 채 시작됐습니다.</h4><div class="himart-brand-metric-card__value"><p>2026 H1 · AD · CPS · CRM 유입 비중</p><strong>68%</strong></div></article>
  ...
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">03</span><h4>장바구니보다 주문·결제 진입이<br>약 3.1배 더 많이 발생했습니다.</h4><div class="himart-brand-metric-card__value"><p>2026.01 MO · 75,808 / 24,237</p><strong>3.1×</strong></div></article>
  <article class="himart-brand-metric-card himart-data-metric-card"><span class="himart-brand-metric-card__index">04</span><h4>검색 비중은 1년 새 약 2.9배 늘어,<br>후보 탐색의 핵심 행동이 됐습니다.</h4><div class="himart-brand-metric-card__value"><p>2025 H1 3.26% → 2026 H1 9.34%</p><strong>9.34%</strong></div></article>
...
const bridge=elFromHTML(`<div class="narrative-block hm-reveal hm-data-bridge-023"><span class="narrative-subno">02.3</span><p class="hm-data-bridge-023__copy">‘온라인몰이 떠오르지 않는다’는 인식과 ‘들어와도 다음 단계로 이어지지 않는다’는 행동이 겹쳤습니다.<br>그래서 목표를 화면 개편이 아니라, ‘구매 여정 안에 하이마트의 명확한 포지션을 만드는 것’으로 다시 정의했습니다.</p></div>`);
