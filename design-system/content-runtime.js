/* Himart content compatibility layer. Animation is intentionally excluded; use design-system/animation.js. */
/* bundled: himart-narrative-v2-final.js */
(()=>{
'use strict';
...
;
/* bundled: himart-narrative-v2-flowfix.js */
(()=>{
'use strict';
...
;
/* bundled: himart-narrative-v2-refine-20260831.js */
(()=>{
'use strict';
...
;
/* bundled: himart-narrative-v2-title-bridge-fix.js */
(()=>{
'use strict';
const q=(r,s)=>r?.querySelector(s)||null;
const qa=(r,s)=>r?[...r.querySelectorAll(s)]:[];
