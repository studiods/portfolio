...
(() => {
  ...
  const projects = [
    ...
    },
    {
      ...
      reflection:'신뢰는 한 번에 만들어지지 않았습니다. 기본기를 쌓자 고객은 믿음으로 반응했습니다. UX디자인팀 리더의 역할을 넘어 촬영·운영·콘텐츠까지 직접 참여했고, 제한된 지역 서비스임에도 <strong>“믿고 구매할 수 있어 좋다”는 후기가 이어졌습니다.</strong> 신뢰가 실제 반응으로 돌아오는 과정을 확인해 큰 성취감을 느낀 프로젝트였습니다.'
    },
    {
