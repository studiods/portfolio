  ...
  const projects = [
    {
      ...
      reflection:'하이마트는 가전 전문기업이라는 상징성은 분명했지만, 그 강점을 온라인 경험으로 연결하는 구조는 충분하지 않았습니다. UX 개선만으로 모든 문제를 해결할 수는 없지만, 고객이 하이마트를 어떻게 인식하고 무엇을 기대하는지부터 다시 확인했습니다. 그리고 다른 주요 커머스에서 기대하는 탐색·비교·구매의 기본기를 먼저 갖추는 것을 가장 큰 과제로 삼았습니다. <strong>하이마트다움은 기본적인 사용 경험이 갖춰진 다음에야 설득력 있게 만들 수 있다고 판단했습니다.</strong>'
    },
    {
