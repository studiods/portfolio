  ...
  const projects = [
    {
      ...
      reflection:'하이마트는 가전 전문기업이라는 상징성은 강했지만, 이를 온라인 경험으로 연결하는 구조는 부족했습니다. 고객이 무엇을 기대하는지 다시 확인하고, 주요 커머스에서 익숙한 탐색·비교·구매의 기본기를 먼저 갖추는 데 집중했습니다. <strong>하이마트다움은 기본적인 사용 경험이 갖춰진 뒤에야 설득력 있게 만들 수 있다고 판단했습니다.</strong>'
    },
    {
      file:'himart-reuse.html', href:'./himart-reuse.html', name:'중고 가전의 신뢰 기준 만들기', en:false,
      reflection:'신뢰는 한 번에 만들어지지 않았습니다. 당연해 보이는 기본기를 하나씩 쌓을 때 고객은 믿음의 신호를 보내기 시작했습니다. UX디자인팀 리더라는 역할에 머물지 않고 촬영·운영·콘텐츠 등 필요한 영역에 직접 참여했고, 제한된 지역 서비스임에도 <strong>“믿고 구매할 수 있어 좋다”는 후기가 이어졌습니다.</strong> 작은 기준들이 실제 신뢰로 돌아오는 과정을 확인해 큰 성취감을 느낀 프로젝트였습니다.'
    },
    {
