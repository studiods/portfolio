(() => {
  ...
  rebuildTabletClusters(journey.querySelector('.journey-signal-subsection'),[
  ...
  if(redesign){
    ...
    rebuildTabletClusters(redesign,[labels[0]||'유입 맥락을 잃지 않고 탐색으로 연결',labels[1]||'비교 기준을 유지해 구매 확신과 설치·케어까지 연결'],['wide-flow-cluster--focus','wide-flow-cluster--focus']);
  }
})();
